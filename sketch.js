...
function setup(){
  ...
  //level 1 
  box1 = new Box(505.75,275,30,40);
  box2 = new Box(537.25,275,30,40);
  box3 = new Box(568.75,275,30,40);
  box4 = new Box(600,275,30,40);
  box5 = new Box(631.25,275,30,40);
  box6 = new Box(662.5,275,30,40);
  box7 = new Box(694,275,30,40);

  //level 2 
  box8 = new Box(537.25,235,30,40);
  box9 = new Box(568.75,235,30,40);
  box10 = new Box(600,235,30,40);
  box11 = new Box(631.25,235,30,40);
  box12 = new Box(662.5,235,30,40);

  //level 3 
  box13 = new Box(568.75,195,30,40);
  box14 = new Box(600,195,30,40);
  box15 = new Box(631.25,195,30,40);
